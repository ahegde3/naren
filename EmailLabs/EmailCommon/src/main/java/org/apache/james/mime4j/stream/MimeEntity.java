    ...
    public EntityStateMachine advance() throws IOException, MimeException {
        ...
        case T_END_HEADER:
            ...
            if (recursionMode == RecursionMode.M_FLAT) {
                ...
                //if found message/rfc822 make mode flat to store as attachment
                recursionMode = RecursionMode.M_FLAT;
                state = EntityState.T_BODY;
                clearMimePartStream();
        ...
        case T_EPILOGUE:
            ...
            break;
        case T_BODY:
        case T_END_MULTIPART://make it recursive once multipart end
