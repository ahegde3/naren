...
public interface ContentDescriptor {
    ...
    /**
     * <p>The body descriptors protocol</p>
     * <p>
     * For <code>signed or encrypted</code> message, this will be protocol used to generate signed or encrypted message.
     * For regular message this property will be null.
     * </p>
     * @return Protocol, which has been parsed from the
     *   content-type definition. Not null for <code>signed or encrypted</code> message.
     *   For regular message this property will be null.
     */
    String getProtocol();
