...
public final class MimeConfig implements Cloneable {
    ...
    public MimeConfig() {
        ...
        this.maxLineLen = 5000;
        this.maxHeaderCount = 5000;
        //
        // 2012 / 07 / 16.
        // modify the default value of MimeConfig as following
        // maxLineLen (1000 -> 5000), maxHeaderCount (1000 -> 5000),
        // maxHeaderLen (10000 -> 50000)
        // this.maxHeaderLen = 14711; failed in single mail (with over 200
        // recipients)
        //
        // 2013 / 04 / 02.
        // modify to not check header length due to USCC intranet message (over
        // 1500 recipients)  "To" field size was over 78KB.
        this.maxHeaderLen = Integer.MAX_VALUE;
