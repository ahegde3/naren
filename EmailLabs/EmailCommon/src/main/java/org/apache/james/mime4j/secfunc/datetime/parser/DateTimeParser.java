...
package org.apache.james.mime4j.secfunc.datetime.parser;
...
public class DateTimeParser implements DateTimeParserConstants {
    ...
    */
    ...
    // [[ regnius add - new pattern : month, day day_of_week year time
    final public DateTime date_time2() throws ParseException {
        int da, m;
        String y;
        Date d;
        Time t;
        ...
        {
            if (true)
                return new DateTime(d.getYear(), d.getMonth(), d.getDay(), t.getHour(),
                        t.getMinute(), t.getSecond(), t.getZone());
        }
        throw new Error("Missing return statement in function");
    }
    ...
    final public DateTime date_time() throws ParseException {
        ...
        switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
            ...
            case 20:
            case 21:
            case 22: // type 2 - month, day day_of_week year time
                return date_time2();
                // regnius add ]]
            default:
                jj_la1[1] = jj_gen;
    ...
    private static void jj_la1_0() {
        jj_la1_0 = new int[] {
                0x2, 0x7f0, 0x7f0, 0x7ff800, 0x800000, 0xff000000, 0xfe000000,
        };
    }
    ...
    final private Token jj_consume_token(int kind) throws ParseException {
        ...
        if (kind == ANY) {// [[ regnius add - skip any char.
            jj_gen++;
            return token;
        }// regnius ]]
        token = oldToken;
