...
/**
 * Utility class for working with character sets. It is somewhat similar to the
 * Java 1.4 <code>java.nio.charset.Charset</code> class but knows many more
 * aliases and is compatible with Java 1.3. It will use a simple detection
 * mechanism to detect what character sets the current VM supports. This will be
 * a sub-set of the character sets listed in the <a
 * href="http://java.sun.com/j2se/1.5.0/docs/guide/intl/encoding.doc.html"> Java
 * 1.5 (J2SE5.0) Supported Encodings</a> document.
 * <p>
 * The <a href="http://www.iana.org/assignments/character-sets"> IANA Character
 * Sets</a> document has been used to determine the preferred MIME character set
 * names and to get a list of known aliases.
 * <p>
 ...
 * <td>ASCII</td>
 * <td>US-ASCII</td>
 * <td>ANSI_X3.4-1968 iso-ir-6 ANSI_X3.4-1986 ISO_646.irv:1991 ISO646-US us
 * IBM367 cp367 csASCII ascii7 646 iso_646.irv:1983</td>
 * </tr>
 * <tr>
 * <td>Big5</td>
 * <td>Big5</td>
 ...
 * <td>EUC_CN</td>
 * <td>GB2312</td>
 * <td>x-EUC-CN csGB2312 euccn euc-cn gb2312-80 gb2312-1980 CN-GB CN-GB-ISOIR165
 * </td>
 * </tr>
 * <tr>
 * <td>EUC_JP</td>
 * <td>EUC-JP</td>
 * <td>csEUCPkdFmtJapanese Extended_UNIX_Code_Packed_Format_for_Japanese eucjis
 * x-eucjp eucjp x-euc-jp</td>
 * </tr>
 * <tr>
 * <td>EUC_JP_LINUX</td>
 * <td>?</td>
 ...
 * <td>EUC_KR</td>
 * <td>EUC-KR</td>
 * <td>csEUCKR ksc5601 5601 ksc5601_1987 ksc_5601 ksc5601-1987 ks_c_5601-1987
 * euckr</td>
 * </tr>
 * <tr>
 * <td>EUC_TW</td>
 ...
 * <td>ISO8859_1</td>
 * <td>ISO-8859-1</td>
 * <td>ISO_8859-1:1987 iso-ir-100 ISO_8859-1 latin1 l1 IBM819 CP819 csISOLatin1
 * 8859_1 819 IBM-819 ISO8859-1 ISO_8859_1</td>
 * </tr>
 * <tr>
 * <td>ISO8859_13</td>
 * <td>ISO-8859-13</td>
 ...
 * <td>ISO8859_15</td>
 * <td>ISO-8859-15</td>
 * <td>ISO_8859-15 Latin-9 8859_15 csISOlatin9 IBM923 cp923 923 L9 IBM-923
 * ISO8859-15 LATIN9 LATIN0 csISOlatin0 ISO8859_15_FDIS</td>
 * </tr>
 * <tr>
 * <td>ISO8859_2</td>
 * <td>ISO-8859-2</td>
 * <td>ISO_8859-2:1987 iso-ir-101 ISO_8859-2 latin2 l2 csISOLatin2 8859_2
 * iso8859_2</td>
 * </tr>
 * <tr>
 * <td>ISO8859_3</td>
 ...
 * <td>ISO8859_6</td>
 * <td>ISO-8859-6</td>
 * <td>ISO_8859-6:1987 iso-ir-127 ISO_8859-6 ECMA-114 ASMO-708 arabic
 * csISOLatinArabic 8859_6</td>
 * </tr>
 * <tr>
 * <td>ISO8859_7</td>
 * <td>ISO-8859-7</td>
 * <td>ISO_8859-7:1987 iso-ir-126 ISO_8859-7 ELOT_928 ECMA-118 greek greek8
 * csISOLatinGreek 8859_7 sun_eu_greek</td>
 * </tr>
 * <tr>
 * <td>ISO8859_8</td>
 * <td>ISO-8859-8</td>
...
public class CharsetUtil {
    ...
    private static Charset[] JAVA_CHARSETS = {
            new Charset("ISO8859_1", "ISO-8859-1", new String[] {
                    "ISO_8859-1:1987", "iso-ir-100", "ISO_8859-1", "latin1", "l1", "IBM819",
                    "CP819", "csISOLatin1", "8859_1", "819", "IBM-819", "ISO8859-1", "ISO_8859_1"
            }),
            ...
            new Charset("ISO8859_5", "ISO-8859-5", new String[] {
                    "ISO_8859-5:1988", "iso-ir-144", "ISO_8859-5", "cyrillic",
                    "csISOLatinCyrillic", "8859_5"
            }),
            new Charset("ISO8859_6", "ISO-8859-6", new String[] {
                    "ISO_8859-6:1987", "iso-ir-127", "ISO_8859-6", "ECMA-114", "ASMO-708",
                    "arabic", "csISOLatinArabic", "8859_6"
            }),
            new Charset("ISO8859_7", "ISO-8859-7", new String[] {
                    "ISO_8859-7:1987", "iso-ir-126", "ISO_8859-7", "ELOT_928", "ECMA-118", "greek",
                    "greek8", "csISOLatinGreek", "8859_7", "sun_eu_greek"
            }),
            ...
            new Charset("ISO8859_15", "ISO-8859-15", new String[] {
                    "ISO_8859-15", "Latin-9", "8859_15", "csISOlatin9", "IBM923", "cp923", "923",
                    "L9", "IBM-923", "ISO8859-15", "LATIN9", "LATIN0", "csISOlatin0",
                    "ISO8859_15_FDIS"
            }),
            new Charset("KOI8_R", "KOI8-R", new String[] {
                    "csKOI8R", "koi8"
            }),
            new Charset("KOI8_U", "KOI8-U", new String[] {
                    "csKOI8U", "koi8u"
            }),
            new Charset("ASCII", "US-ASCII", new String[] {
                    "ANSI_X3.4-1968", "iso-ir-6", "ANSI_X3.4-1986", "ISO_646.irv:1991",
                    "ISO646-US", "us", "IBM367", "cp367", "csASCII", "ascii7", "646",
                    "iso_646.irv:1983"
            }),
            new Charset("UTF8", "UTF-8", new String[] {}),
            new Charset("UTF-16", "UTF-16", new String[] {
                "UTF_16"
            }),
            ...
            new Charset("EUC_KR", "EUC-KR", new String[] {
                    "csEUCKR", "ksc5601", "5601", "ksc5601_1987", "ksc_5601", "ksc5601-1987",
                    "ks_c_5601-1987", "euckr", "ibm-1363_P11B-1998", "ibm-1363", "CP949", "Cp949"
            }),
            new Charset("GB18030", "GB18030", new String[] {
                "gb18030-2000"
            }),
            new Charset("EUC_CN", "GB2312", new String[] {
                    "x-EUC-CN", "csGB2312", "euccn", "euc-cn", "gb2312-80", "gb2312-1980", "CN-GB",
                    "CN-GB-ISOIR165"
            }),
            ...
            new Charset("Cp850", "IBM850", new String[] {
            ...
            new Charset("ISO2022JP", "ISO-2022-JP", new String[] {
            ...
            new Charset("JIS_C6626-1983", "JIS_C6626-1983", new String[] {
                    "x-JIS0208", "JIS0208", "csISO87JISX0208", "x0208", "JIS_X0208-1983",
                    "iso-ir-87"
            }),
            ...
            new Charset("MS932", "Windows-31J", new String[] {
            ...
            new Charset("MS950_HKSCS", "MS950_HKSCS", new String[] {}),
            new Charset("MS874", "windows-874", new String[] {
                "cp874"
            }),
            ...
            new Charset("ISCII91", null, new String[] {
                    "x-ISCII91", "iscii"
            ...
            new Charset("MacRoman", "MacRoman", new String[] {
    ...
    /**
     * Maps character set names to Charset objects. All possible names of a
     * charset will be mapped to the Charset.
     */
    ...
    static {
        ...
        for (int i = 0; i < JAVA_CHARSETS.length; i++) {
            try {
                ...
                decodingSupported.add(JAVA_CHARSETS[i].canonical.toLowerCase(Locale.ENGLISH));
            } catch (UnsupportedOperationException e) {
            }
            try {
                "dummy".getBytes(JAVA_CHARSETS[i].canonical);
                encodingSupported.add(JAVA_CHARSETS[i].canonical.toLowerCase(Locale.ENGLISH));
            } catch (UnsupportedOperationException e) {
        ...
        for (int i = 0; i < JAVA_CHARSETS.length; i++) {
            ...
            charsetMap.put(c.canonical.toLowerCase(Locale.ENGLISH), c);
            if (c.mime != null) {
                charsetMap.put(c.mime.toLowerCase(Locale.ENGLISH), c);
            }
            if (c.aliases != null) {
                for (int j = 0; j < c.aliases.length; j++) {
                    charsetMap.put(c.aliases[j].toLowerCase(Locale.ENGLISH), c);
                }
            }
        }
    ...
    /**
     * ANDROID: THE FOLLOWING SET OF STATIC STRINGS ARE COPIED FROM A NEWER
     * VERSION OF MIME4J
     */
     ...
     * character (CR, LF, SP or HT). ANDROID: COPIED FROM A NEWER VERSION OF
     * MIME4J
     * 
     ...
     * whitespace characters. ANDROID: COPIED FROM A NEWER VERSION OF MIME4J
     * 
    ...
    public static java.nio.charset.Charset lookup(final String name) {
        if (name == null) {
            return null;
        }
        try {
    ...
    /**
     * Determines if the VM supports encoding (chars to bytes) the specified
     * character set. NOTE: the given character set name may not be known to the
     * VM even if this method returns <code>true</code>. Use
     * {@link #toJavaCharset(String)} to get the canonical Java character set
     * name.
     * 
    ...
    public static boolean isEncodingSupported(String charsetName) {
        return encodingSupported.contains(charsetName.toLowerCase(Locale.ENGLISH));
    }

    /**
     * Determines if the VM supports decoding (bytes to chars) the specified
     * character set. NOTE: the given character set name may not be known to the
     * VM even if this method returns <code>true</code>. Use
     * {@link #toJavaCharset(String)} to get the canonical Java character set
     * name.
    ...
    public static boolean isDecodingSupported(String charsetName) {
        return decodingSupported.contains(charsetName.toLowerCase(Locale.ENGLISH));
    }

    /**
     * Gets the preferred MIME character set name for the specified character
     * set or <code>null</code> if not known.
     * 
    ...
    public static String toMimeCharset(String charsetName) {
        Charset c = charsetMap.get(charsetName.toLowerCase(Locale.ENGLISH));
        if (c != null) {
            return c.mime;
        }
        return null;
    ...
    /**
     * Gets the canonical Java character set name for the specified character
     * set or <code>null</code> if not known. This should be called before doing
     * any conversions using the Java API. NOTE: you must use
     * {@link #isEncodingSupported(String)} or
     * {@link #isDecodingSupported(String)} to make sure the returned Java
     * character set is supported by the current VM.
     * 
     * @param charsetName the character set name to look for.
    ...
    public static java.nio.charset.Charset getCharset(String charsetName) {
        ...
        try {
            ...
            log.info("Illegal charset " + charsetName + ", fallback to " + defaultCharset + ": "
                    + e);
            // Use default charset on exception
            return java.nio.charset.Charset.forName(defaultCharset);
        } catch (UnsupportedCharsetException ex) {
            log.info("Unsupported charset " + charsetName + ", fallback to " + defaultCharset
                    + ": " + ex);
            // Use default charset on exception
            return java.nio.charset.Charset.forName(defaultCharset);
        }
    ...
    /*
     * private static String dumpHtmlTable() { LinkedList l = new
     * LinkedList(Arrays.asList(JAVA_CHARSETS)); Collections.sort(l);
     * StringBuffer sb = new StringBuffer(); sb.append(" * <table>\n");
     * sb.append(" *     <tr>\n");
     * sb.append(" *         <td>Canonical (Java) name</td>\n");
     * sb.append(" *         <td>MIME preferred</td>\n");
     * sb.append(" *         <td>Aliases</td>\n"); sb.append(" *     </tr>\n");
     * for (Iterator it = l.iterator(); it.hasNext();) { Charset c = (Charset)
     * it.next(); sb.append(" *     <tr>\n"); sb.append(" *         <td>" +
     * c.canonical + "</td>\n"); sb.append(" *         <td>" + (c.mime == null ?
     * "?" : c.mime)+ "</td>\n"); sb.append(" *         <td>"); for (int i = 0;
     * c.aliases != null && i < c.aliases.length; i++) { sb.append(c.aliases[i]
     * + " "); } sb.append("</td>\n"); sb.append(" *     </tr>\n"); }
     * sb.append(" * </table>\n"); return sb.toString(); } public static void
     * main(String[] args) { System.out.println(dumpHtmlTable()); }
     */

    // return char set of current location.
    public static String getLocalCharset() {

        if (android.os.Build.MODEL.equals("SHW-M180S") == true
                || android.os.Build.MODEL.equals("SHW-M300S") == true
                || android.os.Build.MODEL.equals("SHW-M300W") == true
                || android.os.Build.MODEL.equals("SHW-M380S") == true
                || android.os.Build.MODEL.equals("SHW-M380K") == true
                || android.os.Build.MODEL.equals("SHW-M380W") == true
                || android.os.Build.MODEL.equals("SHW-M250S") == true
                || android.os.Build.MODEL.equals("SHV-M110S") == true
                || android.os.Build.MODEL.equals("SHV-E110S") == true
                || android.os.Build.MODEL.equals("SHV-E120S") == true
                || android.os.Build.MODEL.equals("SHV-E120L") == true
                || android.os.Build.MODEL.equals("SHV-E120K") == true
                || android.os.Build.MODEL.equals("SHV-E160S") == true) {
            return "EUC-KR";
        } else if (android.os.Build.MODEL.equals("GT-P1000") == true) {
            return "ASCII";
        }
        //
        // Add your model name..
        //
            ...
            if (currentLocale.equals(Locale.CHINA) || currentLocale.equals(Locale.CHINESE)) {
                ...
                defaultCharset = "BIG5";
            } else if (currentLocale.equals(Locale.KOREA) || currentLocale.equals(Locale.KOREAN)) {
