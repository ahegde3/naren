 ...
 */
public abstract class NullInputStream extends InputStream {
     ...
     */
    protected abstract int processByte();
     ...
     */
    protected abstract void processBytes(byte[] bytes, int offset, int length);
