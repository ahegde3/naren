...
public class PathFileComparator implements Comparator<File>, Serializable {
     ...
     */
    public static final Comparator<File> PATH_INSENSITIVE_REVERSE = new ReverseComparator<File>(
     ...
     * {@link IOCase#SYSTEM})
     */
    public static final Comparator<File> PATH_SYSTEM_REVERSE = new ReverseComparator<File>(
