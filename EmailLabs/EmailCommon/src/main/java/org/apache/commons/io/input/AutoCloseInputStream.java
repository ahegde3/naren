...
public class AutoCloseInputStream extends ProxyInputStream {
    ...
    /**
     * Reads and returns a single byte from the underlying input stream. If the
     * underlying stream returns -1, the {@link #close()} method is called to
     * automatically close and discard the stream.
     * 
