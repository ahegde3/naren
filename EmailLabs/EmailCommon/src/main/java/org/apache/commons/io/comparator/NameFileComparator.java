...
public class NameFileComparator implements Comparator<File>, Serializable {
     ...
     */
    public static final Comparator<File> NAME_INSENSITIVE_REVERSE = new ReverseComparator<File>(
     ...
     * {@link IOCase#SYSTEM})
     */
    public static final Comparator<File> NAME_SYSTEM_REVERSE = new ReverseComparator<File>(
