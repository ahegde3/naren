...
import com.samsung.android.emailcommon.utility.calendar.EventRecurrence.InvalidFormatException;
...
public class RecurrenceSet {
    ...
    public RecurrenceSet(String rruleStr, String rdateStr, String exruleStr, String exdateStr) throws InvalidFormatException {
        init(rruleStr, rdateStr, exruleStr, exdateStr);
    }

    private void init(String rruleStr, String rdateStr, String exruleStr, String exdateStr) throws InvalidFormatException {
     ...
     */
    public static long[] parseRecurrenceDates(String recurrence) throws InvalidFormatException{
        ...
        for (int i = 0; i<n; ++i) {
            ...
            try {
                ...
                throw new InvalidFormatException( "TimeFormatException thrown when parsing time " + rawDates[i] + " in recurrence " + recurrence);
            }
    ...
    public static boolean populateContentValues(ICalendar.Component component, ContentValues values) {
        ...
        try {
            ...
            String dtstart = dtstartProperty == null ? null : dtstartProperty.getValue();
            ICalendar.Parameter tzidParam = dtstartProperty == null ? null : dtstartProperty.getFirstParameter("TZID");
            ...
            if ((TextUtils.isEmpty(dtstart))|| (TextUtils.isEmpty(duration))||
    ...
    public static boolean populateComponent(ContentValues values, ICalendar.Component component) {
        ...
        if (values.containsKey(CalendarContract.Events.DTSTART)) {
            dtstart = values.getAsLong(CalendarContract.Events.DTSTART) != null ? values.getAsLong(CalendarContract.Events.DTSTART) : -1;
        }
    ...
    */
    ...
    private static String computeDuration(Time start, ICalendar.Component component) {
        ...
        long durationMillis = end.toMillis(false /* use isDst */)- start.toMillis(false /* use isDst */);
    ...
    private static String flattenProperties(ICalendar.Component component, String name) {
        ...
        for (ICalendar.Property property : properties) {
            if (first) {
                ...
                // TODO: use commas.  our RECUR parsing should handle that anyway.
