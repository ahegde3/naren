...
/**
 * A utility class for creating and modifying Strings that are tagged and packed
 * together. Uses non-printable (control chars) for internal delimiters;
 * Intended for regular displayable strings only, so please use base64 or other
 * encoding if you need to hide any binary data here. Binary compatible with
 * Address.pack() format, which should migrate to use this code.
 */
public class PackedString {

    /**
     * Packing format is: element : [ value ] or [ value TAG-DELIMITER tag ]
    ...
    /**
     * Create a packed string using an already-packed string (e.g. from
     * database)
     * 
    ...
    /**
     * Get the value referred to by a given tag. If the tag does not exist,
     * return null.
     * 
    ...
    /**
     * Return a map of all of the values referred to by a given tag. This is a
     * shallow copy, don't edit the values.
     * 
    ...
    private static HashMap<String, String> explode(String packed) {
        ...
        while (elementStartIndex < length) {
            ...
            if (tagEndIndex == -1 || elementEndIndex <= tagEndIndex) {
                // in this case the DELIMITER_PERSONAL is in a future pair (or
                // not found)
                // so synthesize a positional tag for the value, and don't
                // update tagEndIndex
    ...
    /**
     * Builder class for creating PackedString values. Can also be used for
     * editing existing PackedString representations.
     */
    static public class Builder {
        ...
        /**
         * Create a builder using the values of an existing PackedString (for
         * editing).
         */
         ...
         * 
         * @param tag identifier of string of interest
         * @param value the value to record in this position. null to delete
         *            entry.
         */
