...
public class ICalendar {
    ...
    public static class Component {
        ...
        public void toString(StringBuilder sb) {
            ...
            for (String propertyName : getPropertyNames()) {
                properties = getProperties(propertyName);
                if (properties != null) {
    ...
    public static class Property {
        ...
        public void toString(StringBuilder sb) {
            ...
            for (String parameterName : parameterNames) {
                params = getParameters(parameterName);
                if (params != null) {
    ...
    // function?
    private static Component parseComponentImpl(Component component, String text) throws FormatException {
     ...
     */
    private static Component parseLine(String line, ParserState state, Component component) throws FormatException {
        state.line = line;
