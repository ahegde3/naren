...
public class MimeBodyPart extends BodyPart {
    ...
    public void setBody(Body body) throws MessagingException {
        this.mBody = body;
        if (body instanceof com.samsung.android.emailcommon.mail.Multipart) {
            com.samsung.android.emailcommon.mail.Multipart multipart = ((com.samsung.android.emailcommon.mail.Multipart) body);
    ...
    public String getContentId() throws MessagingException {
        ...
        Matcher mMat = REMOVE_OPTIONAL_BRACKETS.matcher(contentId);
        if (mMat.find()) {
            contentId = mMat.group(1);
        }
        return contentId;
    }
