...
public class BinaryTempFileBody implements Body {
    ...
    /**
     * An alternate way to put data into a BinaryTempFileBody is to simply
     * supply an already- created file. Note that this file will be deleted
     * after it is read.
     * 
     * @param filePath The file containing the data to be stored on disk
     *            temporarily
     */
