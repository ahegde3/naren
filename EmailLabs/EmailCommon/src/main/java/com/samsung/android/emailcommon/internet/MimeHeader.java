...
public class MimeHeader {
    ...
    /**
     * Application specific header that is used to tag body parts for
     * quoted/forwarded messages.
     */
     ...
     * 
     * @return CR-NL separated header string except the headers in
     *         writeOmitFields null if header is empty
     */
