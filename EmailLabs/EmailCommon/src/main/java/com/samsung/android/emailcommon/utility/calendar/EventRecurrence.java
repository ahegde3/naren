...
public class EventRecurrence {
    ...
    private static class ParseFreq extends PartParser {
        @Override public int parsePart(String value, EventRecurrence er) {
            Integer freqValue = sParseFreqMap.get(value);
            if (freqValue == null) {
    ...
    private static class ParseBySecond extends PartParser {
        @Override public int parsePart(String value, EventRecurrence er) {
            int[] bysecondValue = parseNumberList(value, 0, 59, true);
            er.bysecond = bysecondValue;
            er.bysecondCount = bysecondValue.length;
    ...
    private static class ParseByMinute extends PartParser {
        @Override public int parsePart(String value, EventRecurrence er) {
            int[] byminuteValue = parseNumberList(value, 0, 59, true);
            er.byminute = byminuteValue;
            er.byminuteCount = byminuteValue.length;
    ...
    private static class ParseByHour extends PartParser {
        @Override public int parsePart(String value, EventRecurrence er) {
            int[] byhourValues = parseNumberList(value, 0, 23, true);
            er.byhour = byhourValues;
            er.byhourCount = byhourValues.length;
    ...
    private static class ParseByDay extends PartParser {
        @Override public int parsePart(String value, EventRecurrence er) {
            ...
            if (value.indexOf(",") < 0) {
                ...
                bydayCountValue = 1;
                bydayValues = new int[1];
                bydayNumValues = new int[1];
                parseWday(value, bydayValues, bydayNumValues, 0);
            } else {
                String[] wdays = value.split(",");
                int len = wdays.length;
                bydayCountValue = len;
                bydayValues = new int[len];
                bydayNumValues = new int[len];
                for (int i = 0; i < len; i++) {
                    parseWday(wdays[i], bydayValues, bydayNumValues, i);
                }
            }
            er.byday = bydayValues;
            er.bydayNum = bydayNumValues;
            er.bydayCount = bydayCountValue;
            return PARSED_BYDAY;
        }
    ...
    private static class ParseByMonthDay extends PartParser {
        @Override public int parsePart(String value, EventRecurrence er) {
            int[] bymonthdayValues = parseNumberList(value, -31, 31, false);
            er.bymonthday = bymonthdayValues;
            er.bymonthdayCount = bymonthdayValues.length;
    ...
    private static class ParseByYearDay extends PartParser {
        @Override public int parsePart(String value, EventRecurrence er) {
            int[] byyeardayValues = parseNumberList(value, -366, 366, false);
            er.byyearday = byyeardayValues;
            er.byyeardayCount = byyeardayValues.length;
    ...
    private static class ParseByWeekNo extends PartParser {
        @Override public int parsePart(String value, EventRecurrence er) {
            int[] byweeknoValues = parseNumberList(value, -53, 53, false);
            er.byweekno = byweeknoValues;
            er.byweeknoCount = byweeknoValues.length;
    ...
    private static class ParseByMonth extends PartParser {
        @Override public int parsePart(String value, EventRecurrence er) {
            int[] bymonthValues = parseNumberList(value, 1, 12, false);
            er.bymonth = bymonthValues;
            er.bymonthCount = bymonthValues.length;
    ...
    private static class ParseBySetPos extends PartParser {
        @Override public int parsePart(String value, EventRecurrence er) {
            int[] bysetposValues = parseNumberList(value, Integer.MIN_VALUE, Integer.MAX_VALUE, true);
            er.bysetpos = bysetposValues;
            er.bysetposCount = bysetposValues.length;
    ...
    private static class ParseWkst extends PartParser {
        @Override public int parsePart(String value, EventRecurrence er) {
            Integer wkstValue = sParseWeekdayMap.get(value);
            if (wkstValue == null) {
