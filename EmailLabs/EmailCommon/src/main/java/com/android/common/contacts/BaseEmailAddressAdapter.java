...
public abstract class BaseEmailAddressAdapter extends CompositeCursorAdapter implements Filterable {
    ...
    public static class MyHandler extends Handler {
        ...
        WeakReference<BaseEmailAddressAdapter> viewHelper;

        public  MyHandler(BaseEmailAddressAdapter view) {
            viewHelper = new WeakReference<BaseEmailAddressAdapter>(
                    view);
        }
        ...
        public void handleMessage(Message msg) {
            if(viewHelper != null) {
                BaseEmailAddressAdapter service = viewHelper.get();
                if(service != null) {
