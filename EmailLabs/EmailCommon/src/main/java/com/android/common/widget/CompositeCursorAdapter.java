...
/*    public CompositeCursorAdapter(Context context) {
     ...
     * specified partition.
     */
    protected abstract int getItemViewType(int partition, int position);
     ...
     */
    protected abstract View newHeaderView(Context context, int partition, Cursor cursor,
            ViewGroup parent);

    /**
     * Binds the header view for the specified partition.
     */
    protected abstract void bindHeaderView(View view, int partition, Cursor cursor);
     ...
     */
    protected abstract boolean isEnabled(int partition, int position);
